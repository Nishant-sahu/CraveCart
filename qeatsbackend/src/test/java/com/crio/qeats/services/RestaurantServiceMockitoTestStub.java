...
public class RestaurantServiceMockitoTestStub {
  ...
  public void testFindNearbyWithin3km() throws IOException {
    ...
    lenient().doReturn(restaurantList2).when(restaurantRepositoryServiceMock)
        .findAllRestaurantsCloseBy(eq(21.0), eq(31.0), eq(LocalTime.of(19, 0)), eq(3.0));


    // when(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(eq(20.0), eq(30.2), eq(LocalTime.of(3, 0)), eq(5.0)))
    //         .thenReturn(restaurantList1);

    //         when(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(eq(21.0), eq(31.1), eq(LocalTime.of(19, 0)), eq(3.0)))
    ...
    allRestaurantsCloseByPeakHours = restaurantService
        .findAllRestaurantsCloseBy(new GetRestaurantsRequest(21.0, 31.0), LocalTime.of(19, 0));
